...
namespace bt
{
    ...
    public:
        ...
        // 핸들러 등록
        void RegisterHandler(std::unique_ptr<IMessageHandler<T>> handler) { handlers_.push_back(std::move(handler)); }
        ...
        // 메시지 전송
        void SendMessage(std::shared_ptr<T> message) { queue_.Push(message); }
