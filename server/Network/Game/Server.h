...
namespace bt
{
    ...
    {
    public:
        Server(const AsioServerConfig& config);
        ~Server();
    ...
    private:
        // 서버 초기화
        void StartAccept();
        void HandleAccept(boost::shared_ptr<Client> client, const boost::system::error_code& error);
    ...
    public:
        void ProcessPacket(boost::shared_ptr<Client> client, const Packet& packet);
    ...
    private:
        ...
        void SendMonsterUpdateResponse(boost::shared_ptr<Client> client, bool success);
        void SendBTExecuteResponse(boost::shared_ptr<Client> client, bool success);
        void SendPlayerJoinResponse(boost::shared_ptr<Client> client, bool success, uint32_t player_id);
        void SendErrorResponse(boost::shared_ptr<Client> client, const std::string& error_message);
