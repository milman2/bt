...
namespace test
{
    ...
    public:
        ...
        {
            position_.x = 0; position_.y = 0; position_.z = 0; position_.rotation = 0;
        }
        ...
        struct Position { float x, y, z, rotation; };
    ...
    {
    public:
        TestAttackAction(const std::string& name, int damage = 20) 
            : Node(name, NodeType::ACTION), damage_(damage) {}
